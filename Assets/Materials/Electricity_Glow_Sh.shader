Shader "ElectricityVertAnimGlow"
{
	Properties 
	{
_Color("_Color", Color) = (0.9253731,0.03452887,0.03452887,1)
_ElectricityBrightness("_ElectricityBrightness", Range(0,10) ) = 0.5
...
float4 Multiply2=_Color * _ElectricityBrightness.xxxx;
